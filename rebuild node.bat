...
pscp.exe -r -pw yourootpassword% C:\k\constantsX.xml root@XXX.XXX.XXX.XXX:"/root/Desktop/join/constants.xml"
pscp.exe -r -pw yourootpassword% C:\k\mykeyXXX.txt root@XXX.XXX.XXX.XXX:"/root/Desktop/join/mykey.txt"
pscp.exe -r -pw yourootpassword% C:\k\launch_docker.sh root@XXX.XXX.XXX.XXX:"/root/Desktop/join/launch_docker.sh"
