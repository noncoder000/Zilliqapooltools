...
class Miner(ModelMixin, mg.Document):
    ...
    work_verified = mg.IntField(default=1)
    total_paid = mg.IntField(default=1)
    last_paid = mg.IntField(default=1)
    bonus_paid = mg.IntField(default=1)
    ...
    def update_stat(self, inc_submitted=0, inc_failed=0, inc_finished=0, inc_verified=0, inc_paid=0, inc_last=0,inc_bonus=0):
        update_kwargs = {
            ...
            "inc__total_paid": inc_paid,
            "inc__last_paid": inc_last,
            "inc__bonus_paid": inc_bonus
        }
